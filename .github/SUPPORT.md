# Getting help with dbox

Thanks for using dbox. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/dbox/issues) to make sure the 
